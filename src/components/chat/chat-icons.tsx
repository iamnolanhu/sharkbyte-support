...
/**
 * Shared SVG icon components for chat widgets
 * These work in both Next.js context and iframe embed context
 */
...
export function WavesIcon({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
